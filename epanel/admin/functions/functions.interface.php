...
function optionsframework_add_admin() {
    ...
    //$of_page = add_theme_page( THEMENAME, 'Site Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
    $of_page = add_menu_page( THEMENAME, 'Site Settings', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
